"""Layer 3 : Staging -> DWH  |  CardTransactions -> FactCardTransaction.
...
# --- Fact-specific settings (only relevant to FactCardTransaction) --------------
SOURCE_DB = "staging"                  # Bank_Staging
TARGET_DB = "dwh"                      # Bank_DWH
STG_TABLE = "dbo.STG_CardTransactions"
FACT_TABLE = "dbo.FactCardTransaction"
...
VALUE_COLUMNS = ["CardTxnNumber", "TxnDate", "Amount", "CurrencyCode", "TxnType", "Status"]
...
FOREIGN_KEYS = [
    {"column": "CardSK", "ref_table": "dbo.DimCard_Type1", "ref_column": "CardSK", "allow_null": False},
    {"column": "MerchantSK", "ref_table": "dbo.DimMerchant_Type1", "ref_column": "MerchantSK", "allow_null": False},
]
...
class TestCardTransactionsFact:
