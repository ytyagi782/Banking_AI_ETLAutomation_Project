"""Layer 3 : Staging -> DWH  |  LoanPayments -> FactLoanPayment.
...
# --- Fact-specific settings (only relevant to FactLoanPayment) --------------
SOURCE_DB = "staging"                  # Bank_Staging
TARGET_DB = "dwh"                      # Bank_DWH
STG_TABLE = "dbo.STG_LoanPayments"
FACT_TABLE = "dbo.FactLoanPayment"
KEY = "LoanPaymentID"
...
VALUE_COLUMNS = ["PaymentNumber", "PaymentDate", "PaymentAmount", "PrincipalComponent", "InterestComponent", "PaymentMethod"]
...
FOREIGN_KEYS = [
    {"column": "LoanSK", "ref_table": "dbo.DimLoan_Type2", "ref_column": "LoanSK", "allow_null": False},
]
