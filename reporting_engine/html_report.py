...
<head>
<meta charset="utf-8">
<title>State_Bank_Of_Noida Report</title>
<style>
...
<body>
  <header>
    <div class="brand">
      ...
      <div class="brand-text">
        <h1>State_Bank_Of_Noida &ndash; Test Execution Report</h1>
        {company_html}
  ...
  <footer>State_Bank_Of_Noida Framework &bull; Automated report</footer>
</body>
</html>"""
